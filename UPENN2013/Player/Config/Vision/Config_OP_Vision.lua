...
vision.ball={};
vision.ball.diameter = 0.040;
vision.ball.th_min_color = 6;
vision.ball.th_min_color2 = 3;
vision.ball.th_min_fill_rate = 0.20--0.35;
vision.ball.th_height_max  = 0.40;
vision.ball.th_ground_boundingbox = {-30,30,0,20};
vision.ball.th_min_green1 = 320;
...
--vision.goal.th_goal_separation = {0.35,3.0}; --FOR OP --DREW our goal sep is 2meters
