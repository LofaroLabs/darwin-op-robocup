...
kick.def["kickForwardLeft"]={
   ...
   def = {
     ...
     {4, 0.6, {-0.03,-0.055,0} , {0.30,0,0},  0.07 , 0*math.pi/180}, --Kicking
...
kick.def["kickForwardRight"]={
  ...
  def = {
    ...
    {5, 0.6, {-0.03 ,0.055,0} , {0.30, 0, 0},  0.07 , 0*math.pi/180},--Kicking
...
kick.def["kickSideLeft"]={
  ...
  def = {
    ...
    {4, 0.4, {-0.01,-0.05,0} , { 0.06,  -0.16,  -0.9},  0.03 , 0*math.pi/180}, --Kicking
...
kick.def["kickSideRight"]={
  ...
  def = {
    ...
    {5, 0.4, {-0.01,0.05,0} , {0.06,  0.16, 0.9},  0.03 , 0*math.pi/180}, --Kicking
...
kick.kickBackRight={
  ...
  {3, 9.6, {-0,0.065,0} , {0.0, 0, 0}, 0.05 ,0*math.pi/180 , 0*math.pi/180}, --Lifting
...
kick.def["kickForwardLeft"]={
   ...
   def = {
     ...
     {4, 0.4, {-0.03,-0.055,0} , {0.30,0,0},  0.07 , 0*math.pi/180}, --Kicking
...
kick.def["kickForwardRight"]={
  ...
  def = {
    ...
    {5, 0.4, {-0.03 ,0.055,0} , {0.30, 0, 0},  0.07 , 0*math.pi/180},--Kicking
