 ...
 * @author drew
 */
public class Status extends Feature/*CategoricalFeature*/{
    ...
    public Status() {
        super("Status");//, new String[] {"Closest", "SecondClosestWithinN", "SecondClosest", "ThirdClosestWithinN", "ThirdClosest"});
        }
