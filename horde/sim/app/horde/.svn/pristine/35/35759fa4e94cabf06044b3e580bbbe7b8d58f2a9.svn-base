 ...
 * @author drew
 */
public class GoalieCloseEnough extends CategoricalFeature{

    private static final long serialVersionUID = 1;

    public static String getType() { return sim.app.horde.agent.SimAgent.TYPE_SIMAGENT; }
    
    public GoalieCloseEnough() {
        super("Goalie Close Enough", new String[] {"NotCloseEnough", "CloseEnough"});
        }
    ...
    public double getValue(Agent agent, Macro parent, Horde horde) {
        ...
        return dp.getGoalieCloseEnough();
        }
