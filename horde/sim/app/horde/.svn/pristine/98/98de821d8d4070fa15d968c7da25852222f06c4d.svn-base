 ...
 * @author drew
 */
public class PassWaitFacing extends Target implements Real{
    
    // seems to be important to have the same so setting it to 1
    private static final long serialVersionUID = 1;
    Double2D negative = new Double2D(-1.8, 0);
    Double2D positive = new Double2D(1.8, 0);
    @Override
    public String toString() {
        return "PassWait Facing x = -/+ 1.8 y = 0"; 
    }
