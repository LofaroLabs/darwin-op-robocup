 ...
 * @author drew
 */
public class IsClosestToBall extends CategoricalFeature{
     private static final long serialVersionUID = 1;

    public static String getType() { return sim.app.horde.agent.SimAgent.TYPE_SIMAGENT; }
    
    public IsClosestToBall() {
        super("IsClosestToBall", new String[] {"NotClosest", "Closest"});
