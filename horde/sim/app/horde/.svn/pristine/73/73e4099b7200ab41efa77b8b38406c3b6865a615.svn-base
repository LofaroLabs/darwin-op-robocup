 ...
 * @author drew
 */
public class TakenSafetyRole extends CategoricalFeature{
     private static final long serialVersionUID = 1;

    public static String getType() { return sim.app.horde.agent.SimAgent.TYPE_SIMAGENT; }
    
    public TakenSafetyRole() {
        super("Taken Safety Role", new String[] {"NotTakenRole", "TakenRole"});
    ...
    public double getValue(Agent agent, Macro parent, Horde horde) {
        ...
        return dp.getSafetyDeclared() == dp.getPlayerID() ? 1 : 0;
        }
}