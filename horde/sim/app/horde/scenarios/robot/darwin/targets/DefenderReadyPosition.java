...
public class DefenderReadyPosition extends Target implements Real{
    ...
    */
    ...
    Double2D positiveDefenderReadyPos = new Double2D(15.2, 12.2);
    Double2D negativeDefenderReadyPos = new Double2D(-15.2, -12.2);
    
    Double2D realPositiveDefenderReadyPos = new Double2D(1.52, 1.22);
    Double2D realNegativeDefenderReadyPos = new Double2D(-1.52, -1.22);
    
    
    
    @Override
    public String toString() {
        return "Defender Ready Position (+/-1.52, +/-1.22)"; // this is the position between the robot and the goal post
    }
