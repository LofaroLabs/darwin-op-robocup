 ...
 * @author drew
 */
public class IsClosestToGoalDefend extends CategoricalFeature{
     private static final long serialVersionUID = 1;

    public static String getType() { return sim.app.horde.agent.SimAgent.TYPE_SIMAGENT; }
    
    public IsClosestToGoalDefend() {
        super("IsClosestToGoalDefend", new String[] {"NotClosest", "Closest"});
    ...
    public double getValue(Agent agent, Macro parent, Horde horde) {
        ...
        return dp.getIsClosestToGoalDefend();
        }
}