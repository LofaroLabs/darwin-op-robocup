    ...
    public void setInput(byte[] input) {
        ...
        synchronized(lock) {
           ...
           // System.err.println(readings);
            ...
            Double2D ball = new Double2D(feature.closestToBallLoc[0], feature.closestToBallLoc[1]);
            Double2D realPositiveGoalTarget = new Double2D(4.5, 0);
            
            System.err.println("Distance between ball and attacking goal = " + ball.distance(realPositiveGoalTarget));
            }
