...
static Darwins[] available = new Darwins[4];
    ...
    public boolean sendMotions = true;
...
*/
 ...
 public void step(SimState state)
    ...
    public void setSendMotions(boolean shouldSend) {
        sendMotions = shouldSend;
    }
    
    public boolean getSendMotions() {
        return sendMotions;
    }
    ...
    public void sendMotion(CommandMotions cms) {
        ...
        {
            desiredAck--; // don't increment ack since I didn't send.
        }
        }
