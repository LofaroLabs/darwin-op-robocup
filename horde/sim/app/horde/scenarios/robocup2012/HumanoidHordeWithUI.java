...
public class HumanoidHordeWithUI extends GUIState implements ImplementsHordeUI
    ...
    ContinuousPortrayal3D ballLocationPortrayal = new ContinuousPortrayal3D(); 
    ContinuousPortrayal3D blueGoalLocationPortrayal = new ContinuousPortrayal3D(); 
    ContinuousPortrayal3D yellowGoalLocationPortrayal = new ContinuousPortrayal3D(); 
    ValueGrid2DPortrayal3D ballGridPortrayal = new ValueGrid2DPortrayal3D(); 
    ContinuousPortrayal2D ballPortrayal = new ContinuousPortrayal2D(); 
    ContinuousPortrayal2D blueGoalPortrayal = new ContinuousPortrayal2D(); 
    ContinuousPortrayal2D yellowGoalPortrayal = new ContinuousPortrayal2D(); 
    ...
    public void setupPortrayals()
        ...
        ballPortrayal.setField(horde.ballField); 
        ballPortrayal.setFrame(Color.orange);
        yellowGoalPortrayal.setField(horde.yellowField); 
        ballPortrayal.setFrame(Color.yellow);
        blueGoalPortrayal.setField(horde.blueField); 
        ballPortrayal.setFrame(Color.blue);
        
        ballLocationPortrayal.setField(horde.ballLocation);
        ballLocationPortrayal.setPortrayalForAll(new SpherePortrayal3D(Color.orange, 12.0));
        ballGridPortrayal.setField(horde.ballGrid);

        blueGoalLocationPortrayal.setField(horde.blueGoalLocation);
        blueGoalLocationPortrayal.setPortrayalForAll(new CubePortrayal3D(Color.green, 12.0));
        
        yellowGoalLocationPortrayal.setField(horde.yellowGoalLocation);
        yellowGoalLocationPortrayal.setPortrayalForAll(new CubePortrayal3D(Color.yellow, 12.0));
        ...
        display3d.setRasterizationMode(javax.media.j3d.PolygonAttributes.POLYGON_LINE);
        }
    ...
    public void attachPortrayals()
        {
        display.attach(ballPortrayal, "Ball Portrayal"); 
        display.attach(yellowGoalPortrayal, "Yellow Goal Portrayal"); 
        display.attach(blueGoalPortrayal, "Blue Goal Prortrayal") ;

        display3d.attach(blueGoalLocationPortrayal, "Blue Goal Location Field"); 
        blueGoalLocationPortrayal.scale(1/1000.0);
        display3d.attach(yellowGoalLocationPortrayal, "Yellow Goal Location Field"); 
        yellowGoalLocationPortrayal.scale(1/1000.0);
        display3d.attach(ballLocationPortrayal, "Ball Location Field"); 
        ballLocationPortrayal.scale(1/1000.0);
        display3d.attach(ballGridPortrayal, "Grid");
        ballGridPortrayal.scale(1/100.0);
        ballGridPortrayal.translate(-1, 0, 0);
    ...
    public void init(final Controller c)
        ...
        // make the displayer
        display = new Display2D(640,480, this);
        display.setClipping(false);

        display3d = new Display3D(640,480, this);
