...
public class ButtonArray extends JPanel
    ...
    public void doEditExamples(Horde horde)
        ...
        if (tm == null) 
        	{
        	sim.util.Utilities.inform("No Training Agent or Macro", "There is no training agent / macro at present.", null);
        	return; 
        	}
    ...
    public void doLog(Horde horde)
        {
        TrainingMacro tm = horde.getTrainingMacro();
        if (tm == null) 
        	{
        	sim.util.Utilities.inform("No Training Agent or Macro", "There is no training agent / macro at present.", null);
        	return; 
        ...
        fd.setVisible(true);
        if (fd.getFile() != null)
            tm.logExamples(fd.getDirectory(), fd.getFile(), horde);
        }
                    ...
                    ActionListener listener = new ActionListener()
                        ...
                        public void actionPerformed(ActionEvent e)
                            ...
                            synchronized(state.state.schedule)
                                ...
                                TrainingMacro tm = horde.getTrainingMacro();
                                if (tm != null) tm.userChangedBehavior((Horde)(state.state), y);
                                }
                            }
                        };
                        ...
                        listener = new ActionListener()
                            ...
                            public void actionPerformed(ActionEvent e)
                                ...
                                synchronized (state.state.schedule)
                                	...
                                	if (tm != null)
                                		{
                                   		tm.stop(horde.getTrainingAgent(), null, horde);
                                    	tm.start(horde.getTrainingAgent(), null, horde);
                                    	}
                                    }
                                }
                            };
