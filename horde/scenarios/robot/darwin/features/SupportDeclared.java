...
/**
 * Someone has declared they are the closest
 * @author drew
 */
public class SupportDeclared extends Feature{

    private static final long serialVersionUID = 1;

    public static String getType() { return sim.app.horde.agent.SimAgent.TYPE_SIMAGENT; }
    
    public SupportDeclared() {
        super("Support Declared");
        }
    ...
    public double getValue(Agent agent, Macro parent, Horde horde) {
        ...
        return dp.getSupportDeclared(); // if it is zero then not declared else declared
        }
