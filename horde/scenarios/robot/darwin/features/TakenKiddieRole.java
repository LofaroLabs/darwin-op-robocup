 ...
 * @author drew
 */
public class TakenKiddieRole extends CategoricalFeature{
     private static final long serialVersionUID = 1;

    public static String getType() { return sim.app.horde.agent.SimAgent.TYPE_SIMAGENT; }
    
    public TakenKiddieRole() {
        super("Taken Kiddie Role", new String[] {"NotTakenRole", "TakenRole"});
    ...
    public double getValue(Agent agent, Macro parent, Horde horde) {
        ...
        return dp.getKiddieDeclared() == dp.getPlayerID() ? 1 : 0;
        }
}