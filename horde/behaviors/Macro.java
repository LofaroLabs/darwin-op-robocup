...
public class Macro extends Behavior
    ...
    public static final long CLEARED_TIMER = -1;
    long[] timers = new long[NUM_TIMERS];
    
                                                              
    public void resetTimer(int timer) { timers[timer] = System.currentTimeMillis(); }  // let's hope it's always positive
    public void clearTimers() { for(int i = 0; i < NUM_TIMERS; i++) timers[i] = CLEARED_TIMER; }
    public long getTimer(int timer) 
    	{
     	long val = timers[timer];
