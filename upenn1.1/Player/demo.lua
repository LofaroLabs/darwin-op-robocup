...
keyframe.load_motion_file("wave.lua",'wave');
keyframe.load_motion_file("wave2.lua",'wave2');
...
function update()
  ...
  if t-t0>demo_interval[demo_phase] then
	t0=t;
